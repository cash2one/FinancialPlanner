...
uses
  ...
  procedure GetStockDataInstant_QQ_All(App: TBaseApp);
...
begin
  ...
  tmpDBStockInstant := TDBStockInstant.Create(DataSrc_QQ);
  try
...
//    exit;
    ...
    begin
      ...
      begin
        ...
        begin
          DataGet_InstantArray_QQ(App, @tmpInstantArray, @tmpHttpClientSession);
          FillChar(tmpInstantArray, SizeOf(tmpInstantArray), 0);        
          tmpIdx := 0;  
          Sleep(100);
        end;
