...
uses
  ...
  StockDayDataAccess in '..\StockDayDataAccess.pas',
  StockDayData_Load in '..\StockDayData_Load.pas',
  StockDetailDataAccess in '..\StockDetailDataAccess.pas',
  StockDetailData_Load in '..\StockDetailData_Load.pas',
