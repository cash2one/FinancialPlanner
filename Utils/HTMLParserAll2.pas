...
type                 
  ...
  THtmlReaderEvent = procedure(AHtmlReader: PHtmlParser);
...
procedure HtmlDomNodeFree(var ADomNode: PHtmlDomNode);
var
  tmpTypeDomNode: PHtmlDocTypeDomNode;
begin
  ...
  begin
    tmpTypeDomNode := PHtmlDocDomNode(ADomNode).DocTypeDomNode;
    if nil <> tmpTypeDomNode then
    begin
      HtmlDomNodeFree(PHtmlDomNode(tmpTypeDomNode));
      PHtmlDocDomNode(ADomNode).DocTypeDomNode := nil;
    end;
    PHtmlDocDomNode(ADomNode).NamespaceURIList.Free;
    PHtmlDocDomNode(ADomNode).SearchNodeLists.Free;
  end;
  if HTMLDOM_NODE_DOCUMENT_TYPE = ADomNode.NodeType then
  begin
    PHtmlDocTypeDomNode(ADomNode).PublicID := '';
    PHtmlDocTypeDomNode(ADomNode).SystemID := '';
    PHtmlDocTypeDomNode(ADomNode).InternalSubset := '';
  end;
...
function CheckOutHtmlDomNode: PHtmlDomNode; overload;
begin
  Result := System.New(PHtmlDomNode);
  FillChar(Result^, SizeOf(THtmlDomNode), 0);
...
function HtmlReaderGetNodeName(AHtmlReader: PHtmlParser): WideString;
begin
...
begin
  ...
  begin
    Result := PHtmlElementDomNode(Node);
    if HtmlDomNodeGetName(PHtmlDomNode(Result)) = HtmlReaderGetNodeName(AHtmlParser) then
      Exit;
    Node := NodeGetParentDomNode(Node);
    if nil = node then Break;
  end;
...
procedure HtmlParserProcessAttributeStart(AHtmlReader: PHtmlParser);
var
  Attr: PHtmlDomNode;
begin
...
procedure HtmlParserProcessAttributeEnd(AHtmlReader: PHtmlParser);
begin
...
procedure HtmlParserProcessDocType(AHtmlReader: PHtmlParser);
var
  tmpDocType: PHtmlDocTypeDomNode;
begin
  //with fHtmlParserData.HtmlReader do
  tmpDocType := createDocumentType(
        HtmlReaderGetNodeName(AHtmlReader.HtmlParser),
        AHtmlReader.HtmlParser.publicID,
        AHtmlReader.HtmlParser.systemID);
    HtmlDocSetdocType(AHtmlReader.HtmlParser.HtmlDocument, tmpDocType);
end;

procedure HtmlParserProcessElementEnd(AHtmlReader: PHtmlParser);
begin
  if AHtmlReader.isEmptyElement or (AHtmlReader.HtmlParser.CurrentTag.Number in EmptyTags) then
...
procedure HtmlParserProcessElementStart(AHtmlReader: PHtmlParser);
var
  Element: PHtmlElementDomNode;
  Parent: PHtmlDomNode;
begin
  AHtmlReader.HtmlParser.CurrentTag := HtmlTagList.GetTagByName(HtmlReaderGetNodeName(AHtmlReader.HtmlParser));
  ...
  Element := CheckOutElementDomNode(AHtmlReader.HtmlParser.HtmlDocument, '', HtmlReaderGetNodeName(AHtmlReader.HtmlParser), false);
...
procedure HtmlParserProcessEndElement(AHtmlReader: PHtmlParser);
var
  Element: PHtmlElementDomNode;
begin
...
procedure HtmlParserProcessEntityReference(AHtmlReader: PHtmlParser);
var
...
procedure HtmlParserProcessTextNode(AHtmlReader: PHtmlParser);
begin
  HtmlDomNodeappendChild(AHtmlReader.CurrentNode,
      CheckOutTextDomNode(HTMLDOM_NODE_TEXT, AHtmlReader.HtmlDocument, AHtmlReader.nodeValue));
end;
...
procedure HtmlReaderSetHtmlStr(AHtmlReader: PHtmlParser; const Value: WideString);
begin
...
function HtmlReaderGetToken(AHtmlReader: PHtmlParser; Delimiters: TDelimiters): WideString;
var
  Start: Integer;
begin
...
function HtmlReaderIsAttrTextChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
...
function HtmlReaderIsDigit(AHtmlReader: PHtmlParser; HexBase: Boolean): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsEndEntityChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsEntityChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsEqualChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsHexEntityChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsNumericEntity(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsQuotation(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsSlashChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsSpecialTagChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsStartEntityChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsStartMarkupChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderIsStartTagChar(AHtmlReader: PHtmlParser): Boolean;
var
  WC: WideChar;
begin
  WC := AHtmlReader.HtmlStr[AHtmlReader.Position];
...
function HtmlReaderMatch(AHtmlReader: PHtmlParser; const Signature: WideString; IgnoreCase: Boolean): Boolean;
var
  I, J: Integer;
  W1, W2: WideChar;
begin
...
procedure HtmlReaderSkipWhiteSpaces(AHtmlReader: PHtmlParser);
begin
  while (AHtmlReader.Position <= Length(AHtmlReader.HtmlStr)) and (Ord(AHtmlReader.HtmlStr[AHtmlReader.Position]) in whiteSpace) do
    Inc(AHtmlReader.Position)
end;

procedure HtmlReaderSetNodeName(AHtmlReader: PHtmlParser; Value: WideString);
var
  I: Integer;
begin
  I := Pos(':', Value);
...
procedure HtmlReaderFireEvent(AHtmlReader: PHtmlParser; Event: THtmlReaderEvent);
begin
  if Assigned(Event) then
    Event(AHtmlReader)
end;

function HtmlReaderReadAttrNode(AHtmlReader: PHtmlParser): Boolean;
var
  AttrName: WideString;
begin
  Result := false;
...
function HtmlReaderReadAttrTextNode(AHtmlReader: PHtmlParser): Boolean;
var
  Start: Integer;
begin
  Result := false;
...
function HtmlReaderSkipTo(AHtmlReader: PHtmlParser; const Signature: WideString): Boolean;
begin
...
function HtmlReaderReadCharacterData(AHtmlReader: PHtmlParser): Boolean;
var
  StartPos: Integer;
begin
...
function HtmlReaderReadComment(AHtmlReader: PHtmlParser): Boolean;
var
  StartPos: Integer;
begin
...
function HtmlReaderReadQuotedValue(AHtmlReader: PHtmlParser; var Value: WideString): Boolean;
var
  QuotedChar: WideChar;
  Start: Integer;
begin
...
function HtmlReaderReadDocumentType(AHtmlReader: PHtmlParser): Boolean;
var
  Name: WideString;
begin
  Result := false;
...
function HtmlReaderReadElementNode(AHtmlReader: PHtmlParser): Boolean;
var
  TagName: WideString;
begin
  Result := false;
...
function HtmlReaderReadEndElementNode(AHtmlReader: PHtmlParser): Boolean;
var
  TagName: WideString;
begin
  Result := false;
...
function HtmlReaderReadNumericEntityNode(AHtmlReader: PHtmlParser): Boolean;
var
  Value: Word;
  HexBase: Boolean;
begin
...
function HtmlReaderReadNamedEntityNode(AHtmlReader: PHtmlParser): Boolean;
var
  Start: Integer;
begin    
  Result := false;
...
function HtmlReaderReadEntityNode(AHtmlReader: PHtmlParser): Boolean;
var
  CurrPos: Integer;
begin
  Result := false;
...
function HtmlReaderIsStartCharacterData(AHtmlReader: PHtmlParser): Boolean;
begin    
  Result := HtmlReaderMatch(AHtmlReader, CDataStartStr, false)
end;

function HtmlReaderIsStartComment(AHtmlReader: PHtmlParser): Boolean;
begin
  Result := HtmlReaderMatch(AHtmlReader, CommentStartStr, false)
end;

function HtmlReaderIsStartDocumentType(AHtmlReader: PHtmlParser): Boolean;
begin
  Result := HtmlReaderMatch(AHtmlReader, DocTypeStartStr, true)
end;

function HtmlReaderReadSpecialNode(AHtmlReader: PHtmlParser): Boolean;
begin
  Result := false;
  Inc(AHtmlReader.Position);
  if AHtmlReader.Position > Length(AHtmlReader.HtmlStr) then
...
function HtmlReaderReadTagNode(AHtmlReader: PHtmlParser): Boolean;
var
  CurrPos: Integer;
begin
  Result := false;
...
function HtmlReaderReadValueNode(AHtmlReader: PHtmlParser): Boolean;
begin
  Result := false;
...
procedure HtmlReaderReadElementTail(AHtmlReader: PHtmlParser);
begin
  HtmlReaderSkipWhiteSpaces(AHtmlReader);
...
procedure HtmlReaderReadTextNode(AHtmlReader: PHtmlParser);
var
  Start: Integer;
begin
  Start := AHtmlReader.Position;
...
function HtmlReaderRead(AHtmlReader: PHtmlParser): Boolean;
begin
...
begin
  ...
  Result.OnAttributeEnd := HtmlParserProcessAttributeEnd;
  Result.OnAttributeStart := HtmlParserProcessAttributeStart;
  Result.OnCDataSection := HtmlParserProcessCDataSection;
  Result.OnComment := HtmlParserProcessComment;
  Result.OnDocType := HtmlParserProcessDocType;
  Result.OnElementEnd := HtmlParserProcessElementEnd;
  Result.OnElementStart := HtmlParserProcessElementStart;
  Result.OnEndElement := HtmlParserProcessEndElement;
  Result.OnEntityReference := HtmlParserProcessEntityReference;
    //OnNotation := ProcessNotation;
    //OnProcessingInstruction := ProcessProcessingInstruction;
  Result.OnTextNode := HtmlParserProcessTextNode;
end;
...
begin
  ...
  begin
    AHtmlParser.PublicID := '';
    AHtmlParser.SystemID := '';
    AHtmlParser.Prefix := '';
    AHtmlParser.LocalName := '';
    AHtmlParser.NodeValue := '';
    AHtmlParser.HtmlStr := '';
