...
uses
  BaseApp, cef_app, UtilsLog, cef_apilib_init;
...
var
  proxyList: ustring;
begin
  //**log(logtag, 'cef_proxy_handler_get_proxy_for_url:' + CefString(url));
  if url <> nil then
  begin
...
var
  str: ustring;
begin
  //sdlog(logtag, 'cef_resource_bundle_handler_get_localized_string');
  Result := 0;
  if Result <> 0 then
...
begin
  ...
  begin
    ...
    sdlog(logtag, 'cef_load_handler_on_load_start:' + tmpurl);
    if tmpurl <> '' then
    begin
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      //sdlog(logtag, 'cef_load_handler_on_load_end:' + tmpurl);
...
begin
  ...
  //sdlog(logtag, 'cef_life_span_handler_on_before_popup:' + tmpurl);
...
begin
  //sdlog(logtag, 'cef_life_span_handler_on_after_created');
  if browser <> nil then
  begin
...
begin
  ...
  //sdlog(logtag, 'cef_request_handler_on_before_browse:' + tmpurl);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        //sdlog(logtag, 'cef_request_handler_on_before_resource_load:' + tmpurl);
        exit;
      end;
      tmpfile := tmpurl;
...
begin
  //sdlog(logtag, 'cef_request_handler_on_resource_redirect:' + CefString(old_url));
end;
...
begin
  ...
  begin
    ...
    if Pos('?' , s) > 0 then
    begin
      //sdlog(logtag, 'cef_request_handler_on_resource_response:' + CefString(url));
      exit;
    end;
...
begin
  //log(logtag, 'cef_request_handler_on_protocol_execution:' + CefString(url));
  Result := 0;
end;
...
begin
  //log(logtag, 'cef_request_handler_get_download_handler:' + CefString(fileName));
  Result := 0;
end;
...
begin
  //sdlog(logtag, 'cef_request_handler_get_auth_credentials');
  Result := 0;
end;
...
begin
//  log(logtag, 'cef_keyboard_handler_on_key_event');
  Result := 0;
end;
...
begin
  Result := 0;
//  log(logtag, 'cef_menu_handler_on_before_menu');
end;
...
begin
//  log(logtag, 'cef_menu_handler_get_menu_label');
end;
...
begin
  Result := 0;
//  log(logtag, 'cef_menu_handler_on_menu_action');
end;
...
begin
  Result := 0;
  //sdlog(logtag, 'cef_permission_handler_on_before_script_extension_load');
end;
...
begin
  Result := 0;
  //sdlog(logtag, 'cef_jsdialog_handler_on_jsalert');
end;
...
begin
  Result := 0;
  //sdlog(logtag, 'cef_jsdialog_handler_on_jsconfirm');
end;
...
begin
  Result := 0;
  //sdlog(logtag, 'cef_jsdialog_handler_on_jsprompt');
end;
...
begin
//**  log(logtag, 'cef_v8_context_handler_on_context_created');
end;
...
begin
//**  log(logtag, 'cef_v8_context_handler_on_context_released');
end;
...
begin
//  log(logtag, 'cef_v8_context_handler_on_uncaught_exception');
end;
...
begin
  Result := 0;
//  sdlog(logtag, 'cef_render_handler_get_view_rect');
end;
...
begin
  Result := 0;
//  sdlog(logtag, 'cef_render_handler_get_screen_rect');
end;
...
begin
//  log(logtag, 'cef_render_handler_on_popup_size');
