...
uses
  ...
  procedure SaveStockWeightData(App: TBaseApp; ADataAccess: TStockWeightDataAccess); overload;
  procedure SaveStockWeightData(App: TBaseApp; ADataAccess: TStockWeightDataAccess; AFileUrl: string); overload;
...
procedure SaveStockWeightDataToBuffer(App: TBaseApp; ADataAccess: TStockWeightDataAccess; AMemory: pointer);
var
...
procedure SaveStockWeightData(App: TBaseApp; ADataAccess: TStockWeightDataAccess);
var
  tmpFileUrl: string;
begin
  ...
  SaveStockWeightData(App, ADataAccess, tmpFileUrl);
end;

procedure SaveStockWeightData(App: TBaseApp; ADataAccess: TStockWeightDataAccess; AFileUrl: string);
var
  tmpWinFile: TWinFile;   
...
begin
  ...
  try
    ...
    begin
      ...
      begin                             
        SaveStockWeightDataToBuffer(App, ADataAccess, tmpFileMapView);
      end;
    end;
  finally
    tmpWinFile.Free;
