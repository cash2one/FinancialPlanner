...
constructor TAmountRateApp.Create(AppClassId: AnsiString);
begin
  inherited;
...
destructor TAmountRateApp.Destroy;
begin
  inherited;
end;
           
function TAmountRateApp.Initialize: Boolean;
var
...
procedure TAmountRateApp.Finalize;
begin
