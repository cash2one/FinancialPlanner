...
uses
  ...
  cyhtAnalysisWinApp in 'cyhtAnalysisWinApp.pas',
  cyhtAnalysisWindow in 'cyhtAnalysisWindow.pas',
  cyhtAnalysisForm in 'cyhtAnalysisForm.pas' {frmCyhtAnalysis};

{$R *.res}

begin
  GlobalApp := TcyhtAnalysisApp.Create('');
  try
