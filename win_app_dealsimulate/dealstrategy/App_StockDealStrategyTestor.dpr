program App_StockDealStrategyTestor;
...
uses
  ...
  FormDealStrategyConsole in 'FormDealStrategyConsole.pas' {frmDataViewer},
  StockDealStrategyApp in 'StockDealStrategyApp.pas';

{$R *.res}

var
  GlobalApp: TStockDealStrategyApp;
begin
  GlobalApp := TStockDealStrategyApp.Create('');
  try
